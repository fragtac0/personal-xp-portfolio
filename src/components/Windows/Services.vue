        ...
        <div class="w-full gap-4 mb-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div class="bg-gray-50 p-4 rounded">
              ...
              <p class="text-2xl font-bold text-blue-600">{{ /^[\d]/.test(goBackStore.currentActiveService.price) ? '₹' + goBackStore.currentActiveService.price : goBackStore.currentActiveService.price }}</p>
            </div>
